...
export const fundoClaro = "#f1f1f1"; //#f1f1f1
export const conteudoClaro = "white"; //white
export const textoFundoClaro = "black"; //black
export const iconesClaro = COR_PRINCIPAL;
