...
export default function HistoricoEscolar(){
  ...
  const [tableHeadGeral, setTableHeadGeral] = useState(['Coeficiente de rendimento', 'Média de presença'])
  ...
  return(
    <ScrollView style={styles.container}>
      <Text style={style.periodo}>1 série - 1 periodo</Text>
        ...
        <Table borderStyle={{borderWidth: 2, borderColor: '#c8e1ff'}}>
          <Row data={tableHeadGeral} style={styles.head} textStyle={styles.text}/>
