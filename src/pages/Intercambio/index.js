...
export default function Intercambio(){
  ...
  const [tableHead, setTableHead] = useState(['Título', 'Info', 'Inicio', 'Fim'])
  const [tableData, setTableData] = useState([
    ['Edital Universidade de Luxemburgo 1.2022 (Retificação Publicada)', elementButton('eita'), '01/09/2021', '22/09/2021'],
    ['Edital Universidade de Luxemburgo 1.2022 (Retificação Publicada)', elementButton('eita'), '01/09/2021', '22/09/2021'],
    ...
    <ScrollView style={styles.container}>
      <View style={{marginTop: 20}}>
        <Table borderStyle={{borderWidth: 2, borderColor: '#c8e1ff'}}>
          ...
          <Rows data={tableData} textStyle={styles.text} flexArr={[2, 1, 1, 1, 1]} />
        </Table>
      </View>
...
const styles = StyleSheet.create({
  ...
  btn: { width: 58, marginLeft: 10, height: 23, backgroundColor: COR_PRINCIPAL, borderRadius: 4 },
